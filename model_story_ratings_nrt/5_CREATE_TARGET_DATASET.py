...
class CreateTargetDataset():
    ...
    def __init__(self):
        ...
        self.script_name = "SBBOL_CREATE_TARGET_DATASET_NRT"
        self.currdate = datetime.strftime(datetime.today(), format='%Y-%m-%d')

        self.input_cheme = SBX_TEAM_DIGITCAMP
        self.dataset_table = "RECSYS_STORY_DATASET_POSITIVE_NRT"
        ...
        self.dataset_target_table = "RECSYS_STORY_DATASET_TARGET_NRT"
        self.item_dict_target_table = "RECSYS_STORY_TARGET_ITEM_DICT_NRT"
