...
class CreateSbbolDatasetNrt():
    ...
    def __init__(self):
        ...
        self.script_name = "CREATE_SBBOL_DATASET_NRT"
        self.currdate = datetime.strftime(datetime.today(), format='%Y-%m-%d')

        self.input_scheme = SBX_TEAM_DIGITCAMP
        self.clickstreame_table = "RECSYS_STORY_CLICKSTREAM_NRT"
        self.item_dict_table = "RECSYS_STORY_ITEM_DICT_NRT"
        self.user_dict_table = "RECSYS_STORY_USER_DICT_NRT"

        self.output_scheme = SBX_TEAM_DIGITCAMP
        self.full_dataset_table = "RECSYS_STORY_DATASET_NRT"
        self.pos_dataset_table = "RECSYS_STORY_DATASET_POSITIVE_NRT"
...
if __name__ == '__main__':
    with CreateSbbolDatasetNrt() as create_sbbol_dataset_nrt:
        create_sbbol_dataset_nrt.run()
