...
class SbbolAlsPrediction():
    ...
    def __init__(self):
        self.script_name = "ALS_SBBOL_PREDICTION"
        self.currdate = datetime.strftime(datetime.today(), format='%Y-%m-%d')

        self.input_scheme = SBX_TEAM_DIGITCAMP
        self.train_table = RECSYS_STORY_DATASET_POSITIVE
        self.test_table = RECSYS_STORY_DATASET_TARGET
...
if __name__ == '__main__':
    with SbbolAlsPrediction() as als_sbbol_prediction:
