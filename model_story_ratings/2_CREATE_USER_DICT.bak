...
class CreateSbbolUserDict():
    ...
    def __init__(self):
        ...
        self.script_name = "CREATE_USER_DICT_SBBOL"
        ...
        self.output_table = RECSYS_STORY_USER_DICT
...
if __name__ == '__main__':
    with CreateSbbolUserDict() as create_user_dict:
        create_user_dict.run()
